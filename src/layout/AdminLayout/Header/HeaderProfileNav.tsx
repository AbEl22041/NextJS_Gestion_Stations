...
export default function HeaderProfileNav() {
  ...
  return (
    <Nav>
      <Dropdown as={NavItem}>
            <Dropdown.Toggle variant="link" bsPrefix="hide-caret" className="py-0 px-2 rounded-0 mb-2" id="dropdown-profile">
        ...
        <Dropdown.Menu className="pt-0">
          <Dropdown.Header className="bg-light fw-bold rounded-top">Compte</Dropdown.Header>
          ...
          <Link href="#" passHref legacyBehavior>
            <Dropdown.Item>
              <ItemWithIcon icon={faLock}>Verrouiller le compte</ItemWithIcon>
            </Dropdown.Item>
          </Link>
          <Dropdown.Item onClick={logout}>
            <ItemWithIcon icon={faPowerOff}>Déconnexion</ItemWithIcon>
          </Dropdown.Item>
        </Dropdown.Menu>
      </Dropdown>
    </Nav>
